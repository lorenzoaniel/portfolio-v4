...
const initialState = {
	...
	Projects: {
		Tenzies: {
			...
			img: "src/assets/images/Static/tenziesIMG.png",
		},
		Portfolio1: {
			name: "PORTFOLIO-V1",
			...
			img: "src/assets/images/Static/portfoliov1IMG.png",
		},
		Portfolio2: {
			name: "PORTFOLIO-V2",
			...
			img: "src/assets/images/Static/portfoliov2IMG.png",
		},
		Portfolio3: {
			name: "PORTFOLIO-V3",
			...
			img: "src/assets/images/Static/portfoliov3IMG.png",
		},
		SaasifyDemo: {
			name: "SAASIFY DEMO",
			...
			img: "src/assets/images/Static/saasifydemoIMG.png",
		},
		GPTDemo: {
			name: "GPT DEMO",
			...
			img: "src/assets/images/Static/gpt3demoIMG.png",
		},
	},
} as infoState;
